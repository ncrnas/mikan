...
#include <mikan/lib/pita_ddg/ViennaRNA/include/vr16_params.hpp>                // VR16Params
#include <vector>
#include <string>
...
public:
    ...
    VR16PartFunc(VR16EnergyParams& pEn, VR16Params& pParams, VR16PFParams& pPFParams, VR16PairMat& pPairMat,
        ...
        mStBack(false), mInitLength(0), mEn(pEn), mParams(pParams), mPFParams(pPFParams), mPairMat(pPairMat), mOpts(pOpts)
    {}
