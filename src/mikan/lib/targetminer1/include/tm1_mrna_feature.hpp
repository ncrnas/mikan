...
public:
    ...
    int add_features(unsigned pIdx, const seqan::String<unsigned> &pSortedSites,
                     mikan::MKSeedSites &pSeedSites, TM1SiteFeatures &pSiteFeatures);
...
public:
    ...
    // Method prototype
    int add_features(unsigned pIdx, const seqan::String<unsigned> &pSortedSites,
                     mikan::MKSeedSites &pSeedSites, TM1SiteFeatures &pSiteFeaturess);
...
public:
    ...
    // Method prototype
    int add_features(unsigned pIdx, const seqan::String<unsigned> &pSortedSites,
                     mikan::MKSeedSites &pSeedSites, TM1SiteFeatures &pRawFeatures);
...
public:
    ...
    // Method prototypes
    int add_features(mikan::MKSeedSites &pSeedSites, mikan::MKRMAWithSites &pRNAWithSites,
