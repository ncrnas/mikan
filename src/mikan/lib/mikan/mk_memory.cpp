...
template double *******
create_7d_array<double>(int len7, int len6, int len5, int len4, int len3, int len2, int len1);

template double ********
create_8d_array<double>(int len8, int len7, int len6, int len5, int len4, int len3, int len2,
                        int len1);
