...
template class TS5FeatSeedType<TRNATYPE>;
template class TS5FeatSitePos<TRNATYPE>;
template class TS5FeatAURich<TRNATYPE>;
template class TS5FeatThreePrimePair<TRNATYPE>;
template class TS5RawFeatures<TRNATYPE>;
