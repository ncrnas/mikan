...
template class TSSVMFeatUTRLen<TRNATYPE>;
template class TSSVMFeatSiteNum<TRNATYPE>;
template class TSSVMFeatTotDiscUTRLen<TRNATYPE>;
template class TSSVMFeatSeedTypeNum<TRNATYPE>;
template class TSSVMFeatDiscBin<TRNATYPE>;
template class TSSVMFeatOptDist<TRNATYPE>;
template class TSSVMFeatSiteNumFlg<TRNATYPE>;
template class TSSVMFeatTotDisc<TRNATYPE>;

template class TSSVMRNARawFeatures<TRNATYPE>;
