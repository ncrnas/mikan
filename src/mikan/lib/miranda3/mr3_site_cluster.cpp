...
template <class TRNAString>
void MR3Overlap<TRNAString>::mark_overlapped_sites(MR3SeedSites<TRNAString> &pSeedSites, int pPrevIdx, int pCurIdx)
{
...
template class MR3SiteCluster<TRNATYPE>;
template class MR3Overlap<TRNATYPE>;
template class MR3SortedSitePos<TRNATYPE>;
