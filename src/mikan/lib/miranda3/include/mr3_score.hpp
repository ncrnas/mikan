...
#include <mikan/lib/miranda3/include/mr3_align.hpp>          // MR3SeedSites
#include <mikan/lib/miranda3/include/mr3_seed_site.hpp>      // MR3Align
#include <mikan/lib/vienna_rna/include/vr16_fold_core.hpp>     // VR16FoldWorkSpace
#include <vector>
#include <string>
#include <sstream>
