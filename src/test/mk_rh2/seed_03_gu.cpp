...
TEST_F(SeedGU, mir1_6m_gu_plus) {
    ...
    test_seed2("GGAACG", 2, "6mer_GUM", true);
    test_seed2("GGAACA", 3, "6mer_GUM", true);

    test_seed2("GAAAUG", 4, "6mer_GUT", true);
    test_seed2("GAAAUA", 5, "6mer_GUT", true);
    test_seed2("GAAACG", 6, "6mer_GUT", true);
    test_seed2("GAAACA", 7, "6mer_GUT", true);

    test_seed2("AGAAUG", 8, "6mer_GUT", true);
    test_seed2("AGAAUA", 9, "6mer_GUT", true);
    test_seed2("AGAACG", 10, "6mer_GUT", true);
    test_seed2("AGAACA", 11, "6mer_GUT", true);
