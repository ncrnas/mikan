...
typedef TestSeed<ts5cs::TS5SeedSeqs, ts5cs::TS5CSOptions, TestIOTS5> TestSeedTS5;
typedef TestSite<ts5cs::TS5SeedSites, ts5cs::TS5SeedSeqs, ts5cs::TS5CSOptions, TestIOTS5> TestSiteTS5;
