...
namespace {
    ...
    TEST_F(Site03MM2, mir1_def) {
        ...
        int ret_val = sites.find_seed_sites(mirna_seqs[1], mSeedDef);
        EXPECT_EQ(0, ret_val);
        EXPECT_EQ(102u, sites.get_length());
        ...
        test_sites(sites, 82, "7mer_BT", 4, 23, true, 1);
        test_sites(sites, 83, "7mer_BT", 5, 23, true, 1);
        test_sites(sites, 84, "7mer_BT", false, 23, true, 1);
        test_sites(sites, 85, "7mer_BT", true, 23, true, 1);

        test_sites(sites, 86, "BT", 2, 23, false, 0);
        test_sites(sites, 87, "BT", 3, 23, false, 0);
        test_sites(sites, 88, "BT", 34, 23, false, 0);
        test_sites(sites, 89, "BT", 35, 23, false, 0);
        test_sites(sites, 90, "BT", 28, 24, false, 0);
        test_sites(sites, 91, "BT", 29, 24, false, 0);
        test_sites(sites, 92, "7mer_BT", 30, 24, true, 4);
        test_sites(sites, 93, "BT", 31, 24, false, 0);
        test_sites(sites, 94, "8mer_BT", 32, 24, true, 4);
        test_sites(sites, 95, "BT", 33, 24, false, 0);
        test_sites(sites, 96, "BT", 34, 24, false, 0);
        test_sites(sites, 97, "BT", 35, 24, false, 0);
        test_sites(sites, 98, "7mer_BT", 36, 24, true, 5);
        test_sites(sites, 99, "BT", 37, 24, false, 0);
        test_sites(sites, 100, "8mer_BT", 38, 24, true, 5);
        test_sites(sites, 101, "BT", 39, 24, false, 0);
    }
}
