...
namespace {
    ...
    TEST_F(Site06BM2, mir1_bm) {
        ...
        test_sites(sites, 4, "BT", 7, 26, false, 0);
        test_sites(sites, 5, "BT", 6, 26, false, 0);
    }
    ...
    TEST_F(Site06BM2, mir1_def) {
        ...
        test_sites(sites, 12, "BT", 7, 26, false, 0);
        test_sites(sites, 13, "BT", 6, 26, false, 0);
    }
}
