...
namespace {
    ...
    TEST_F(Site04MMGU2, mir1_def) {
        ...
        int ret_val = sites.find_seed_sites(mirna_seqs[1], mSeedDef);
        EXPECT_EQ(0, ret_val);
        EXPECT_EQ(98u, sites.get_length());
        ...
        test_sites(sites, 94, "BT", 24, 23, false, 0);
        test_sites(sites, 95, "BT", 25, 23, false, 0);
        test_sites(sites, 96, "7mer_BT", 6, 23, true, 1);
        test_sites(sites, 97, "7mer_BT", 7, 23, true, 1);
