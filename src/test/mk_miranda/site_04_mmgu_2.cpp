...
TEST_F(Site04MMGU2, mir1_def) {
    ...
    EXPECT_EQ(194u, sites.get_length());
...
//    test_sites(sites, 197, "BT", 21, 23, false, 0);
    ...
    test_sites(sites, 188, "7mer_BT", 6, 23, true, 1);
    test_sites(sites, 189, "7mer_BT", 7, 23, true, 1);

    test_sites(sites, 190, "8mer_BT", 82, 24, true, 2);
//    test_sites(sites, 201, "BT", 83, 24, false, 0);
    test_sites(sites, 191, "7mer_BT", 84, 24, true, 2);
//    test_sites(sites, 203, "BT", 85, 24, false, 0);

    test_sites(sites, 192, "8mer_BT", 86, 24, true, 3);
//    test_sites(sites, 205, "BT", 87, 24, false, 0);
    test_sites(sites, 193, "7mer_BT", 88, 24, true, 3);
