...
namespace {
    ...
    TEST_F(Site05BT1, mir124_def) {
        ...
        test_sites(sites, 27, "7mer_BT", 11, 24, true, 3);
        test_sites(sites, 28, "8mer_BT", 12, 24, true, 3);
        test_sites(sites, 29, "8mer_BT", 13, 24, true, 3);
        test_sites(sites, 30, "8mer_BT", 14, 24, true, 3);
    }
