...
TEST_F(Site04MMGU2, mir1_mmgu) {
    ...
    test_sites2(sites, 14, "6mer", 14, 24, true);
    test_sites2(sites, 15, "7mer-A1", 15, 24, true);
    test_sites2(sites, 16, "7mer-m8", 16, 24, true);
    test_sites2(sites, 17, "8mer", 17, 24, true);
    ...
    test_sites2(sites, 24, "6mer", 24, 24, true);
    test_sites2(sites, 25, "7mer-A1", 25, 24, true);

    test_sites2(sites, 26, "6mer", 54, 24, true);
    test_sites2(sites, 27, "6mer", 55, 24, true);
    test_sites2(sites, 28, "6mer", 56, 24, true);
    test_sites2(sites, 29, "6mer", 57, 24, true);

    test_sites2(sites, 30, "6mer", 74, 24, true);
    test_sites2(sites, 31, "6mer", 75, 24, true);
    test_sites2(sites, 32, "6mer", 76, 24, true);
    test_sites2(sites, 33, "6mer", 77, 24, true);

    test_sites2(sites, 34, "6mer", 90, 24, true);
    test_sites2(sites, 35, "6mer", 91, 24, true);
    test_sites2(sites, 36, "6mer", 92, 24, true);
    test_sites2(sites, 37, "6mer", 93, 24, true);

    test_sites2(sites, 38, "6mer", 36, 24, true);
    test_sites2(sites, 39, "6mer", 37, 24, true);
}
